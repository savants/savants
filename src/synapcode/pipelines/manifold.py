...
from synapcode.pipelines.router import RouteDecision, route_request
...
class Pipeline:
    ...
    def pipe(
        ...
        model_id = body.get("model", "synapcode-auto")
