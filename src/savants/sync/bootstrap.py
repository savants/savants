...
SNAPSHOT_FILENAME = ".savants/graph.dump"
LFS_TRACK_PATTERN = ".savants/*.dump"
...
def create_snapshot(repo_path: str, graph_name: str = "savants") -> Path:
...
def restore_snapshot(repo_path: str, graph_name: str = "savants") -> bool:
