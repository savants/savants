...
from savants.security.secret_scrub import (
...
def _looks_like_symbol(s: str) -> bool:
    ...
    src/savants/security/secret_scrub.py for the full pattern list.
    """
...
class CodePropertyGraphBuilder:
    ...
    def build_incremental(
        ...
        """
        excluded_parts = {"node_modules", ".git", "__pycache__", "venv", ".venv", "dist", "build", ".savants"}
