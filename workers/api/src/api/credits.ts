...
export const TOOL_CREDITS: Record<string, number> = {
  ...
  search_github_prs: 1,
  list_github_issues: 1,
  list_github_prs: 1,
  get_github_commit: 3,
  list_github_commits: 1,
  get_github_file: 1,
  add_github_comment: 1,
  create_github_pr: 5,
  merge_github_pr: 5,
  list_github_actions: 1,
  get_github_action_run: 1,
  get_github_action_logs: 3,
  list_github_releases: 1,
  list_code_scanning_alerts: 1,
  // Sentry tools
  get_sentry_issue: 3,
